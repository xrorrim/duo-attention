...
MODEL_SELECT() {
    ...
    case $MODEL_NAME in
        ...
        Llama-3-8B-Instruct-Gradient-1048k)
            MODEL_PATH=${MODEL_DIR}/Llama-3-8B-Instruct-Gradient-1048k
            MODEL_TEMPLATE_TYPE="meta-llama3" # base, meta-chat, etc. defined in `scripts/data/template.py`
            MODEL_FRAMEWORK="hf" # hf or vllm
            ;;
    esac
